...
| `suspicious_encoding` | custom_detector | 0.7 | Base64 blocks in plain text, zero-width chars (the `ZeroWidth` set: Default_Ignorable_Code_Point minus variation selectors), bidi controls, excessive unicode escapes |
